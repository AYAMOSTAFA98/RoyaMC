...
class AppColorsLight implements IAppColors {
  @override
  final Color primaryColor = const Color(0xff87AFB1);
  @override
  final Color primary = const Color(0xff87AFB1);
  @override
  final Color secondary = const Color(0xFF222F66);
  ...
  @override
  final Color scaffoldBGColor = const Color(0xFFFFFFFF);
  @override
  final Color bottomNavBarColor = const Color(0xFFFFFFFF);

  @override
  final Color textFieldSubtitle1Color = const Color(0xFFFFFFFF);
  @override
  final Color textFieldHintColor = const Color(0xff9b9b9b);
  @override
  final Color textFieldCursorColor = const Color(0xFFFFFFFF);
  @override
  ...
  @override
  final Color iconColor = const Color(0xFF222F66);
