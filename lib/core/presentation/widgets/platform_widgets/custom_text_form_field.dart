...
class CustomTextFormField extends StatelessWidget {
  const CustomTextFormField({
    ...
    this.maxLines,
    this.minLines,
    this.errorMaxLines, this.onChanged,
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: Sizes.textFieldPaddingH42,),
      child: Column(
        children: [
          Stack(
            alignment: Alignment.center,
            children: [
              PlatformTextFormField(onChanged: onChanged,
                  ...
                  decoration: InputDecoration(
                    ...
                    contentPadding: contentPadding ??
                        const EdgeInsets.symmetric(
                          vertical: Sizes.textFieldPaddingV10,
          ...
          const Divider(color: AppStaticColors.white,height: 0.01,),
        ],
      ),
    );
  }
